            ...
            <div className='testmonial-section'>
                <div className='inner-test-div right'>
                    <div className='test-div'>
                        ...
                        <h4>Julie Kimmel <br /><span className='passion'> Student </span></h4>
                    </div>
                    <div className='test-div'>
                        <img src={img1} className='test-image' />
                        ...
                        <h4>Daniel <br /><span className='passion'> Corporates </span></h4>
                    </div>
                    <div className='test-div'>
                        <img src={img1} className='test-image' />
                        ...
                        <h4>Rashmi Kheni<br /><span className='passion'> Student </span></h4>
                    </div>
                    ...
                    <div className='test-div'>
                        ...
                        <h4>Kruti Malkan<br /><span className='passion'> Student </span></h4>
                    </div>
                ...
                <div className='inner-test-div left'>
                    <div className='test-div'>
                        ...
                        <h4>Brittany Gooding:<br /><span className='passion'>  Wedding Guest </span></h4>
                    </div>
                    ...
                    <div className='test-div'>
                        ...
                        <h4>Jahnavi Muppaneni:<br /><span className='passion'> Student & Miss Texas Contestant </span> </h4>
                    </div>
                    <div className='test-div'>
                        <img src={img1} className='test-image' />
                        ...
                        <h4>Custodio Coutinho <br /><span className='passion'> Student </span></h4>
                    </div>
